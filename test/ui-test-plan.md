...
```json
{
  "cases": [
    ...
    },
    {
      ...
      "commands": ["list", "bye"],
      "expected": ["1.[T][X] read book\n     2.[D][ ] return book (by: Dec 02 2019)\n     3.[E][ ] project meeting (from: Jan 01 2025 2.00 pm to: Jan 01 2025 4.00 pm)", "Bye! Keep learning"]
    },
    {
    ...
    },
    {
      ...
      "expected": ["Now you have 1 tasks in the list.", "Now you have 2 tasks in the list.", "Now you have 3 tasks in the list.", "Now you have 2 tasks in the list.", "1.[T][ ] read book\n     2.[E][ ] project meeting (from: Aug 06 2025 2.00 pm to: Aug 06 2025 4.00 pm)", "Bye! Keep learning"]
    },
    {
    ...
    },
    {
      ...
      "expected": ["Now you have 1 tasks in the list.", "Now you have 2 tasks in the list.", "Now you have 3 tasks in the list.", "1.[T][ ] read book\n     2.[D][ ] return book (by: Dec 02 2019)", "No matching tasks found.", "Bye! Keep learning"]
    }
  ]
}
```
